...
// NewHealthCheckerSetup creates a new health checker setup for userservice
...
// NewShutdownManagerSetup creates a new shutdown manager for userservice
...
// NewServiceSetup creates a complete service setup for userservice
